# 📌 Mobile Manufacturer — SQL Case Study

This repository contains a complete SQL case study based on a fictional Mobile Manufacturer dataset.
It includes database creation scripts, data loading scripts, and analytical SQL queries to solve real-world business questions.

# 🎯 Objective

To analyze customer behavior, manufacturer performance, yearly trends, product pricing, and top-performing models using SQL.
This project demonstrates end-to-end data analysis using industry-level SQL skills.
